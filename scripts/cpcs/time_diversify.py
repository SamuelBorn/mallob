...
if __name__ == '__main__':
    ...
    parser.add_argument("-n", help="Tests to perform per clauses to delete", type=int, default=1)
    parser.add_argument("-d", help="Max Percentage to clauses to delete", type=float, default=0.9)
