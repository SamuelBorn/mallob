...
public:
    ...
    JobDescription& operator=(JobDescription&& other) {
        ...
        _check_external = std::move(other._check_external);
    ...
    bool shouldCheckShared() const {return _check_external;}
    ...
    void setCheckExternal(bool check_external) { _check_external = check_external;}
